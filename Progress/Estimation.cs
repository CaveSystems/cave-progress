...
namespace Cave
{
    ...
    public abstract class Estimation : IEstimation // MakeInternal:KEEP
    {
        ...
        public EstimationItem[] Items => items.ToArray();
        ...
        /// <summary>
        /// Gets the current progress of the process.
        /// </summary>
        ...
        /// <summary>
        /// Gets the estimated completion time of the process.
        /// </summary>
        public abstract DateTime EstimatedCompletionTime { get; }

        /// <summary>
        /// Gets the estimated time left based on the current time.
        /// </summary>
